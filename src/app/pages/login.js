...
export default function Login() {
  ...
  return (
    <div className="flex min-h-screen w-full bg-slate-50">
      {/* القسم الأيسر: الصورة العريضة بالتأثير البرتقالي والنصوص */}
      <div className="relative hidden w-1/2 flex-col justify-between p-12 lg:flex overflow-hidden">
        ...
        <div className="relative z-10 my-auto max-w-lg">
          ...
          <p className="mt-4 text-sm leading-relaxed text-gray-100 drop-shadow">
            One secure platform for managing operations, invoices, and financial tracking with clarity and efficiency.
          </p>
        </div>
...
>
  Sign up
        ...
        <div className="mx-auto w-full max-w-md py-8">
          <span className="text-xs font-semibold uppercase tracking-wider text-orange-500">Welcome back</span>
          <h2 className="mt-1 text-3xl font-extrabold text-gray-900">Sign in</h2>
          <p className="mt-2 text-sm text-gray-500">
            Enter your account details to access your assigned workspace.
          </p>
